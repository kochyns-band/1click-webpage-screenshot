    ...
    },
    {
        ...
        onclick: function (scope) {
            ...
            chrome.storage.local.get('odoo_screenshots', function (data) {
                var new_data = {};
                if (data.hasOwnProperty("odoo_screenshots")) {
                    new_data = data['odoo_screenshots'];
                }
                ...
                new_data[id] = {
                    ...
                    'data': scope.image_base64(),
                };
                chrome.storage.local.set({'odoo_screenshots': new_data}, function () {
...
//   },
    ...
    // 					"mimeType": "image/png",
    // 					"description": 'Taken by Screenshot Extension. http://www.openscreenshot.com'
    // 				};
    ...
    // 		key: 'facebook',
    // 		dataType: 'image',
    // 		url: "http://www.facebook.com/sharer.php?u=%s&t=" + ' Captured by Screenshot Extension - https://www.openscreenshot.com'
    // 	},
...
// 		key: 'microsoft',
// 		dataType: 'image',
// 		url: 'https://dub117.mail.live.com/default.aspx?rru=compose&subject=OpenScreenshot&body=%s' + encodeURIComponent(' Captured by Screenshot Extension - https://www.openscreenshot.com')
// 	},
// 	//       {
// 	//           name:  'myspace',
// 	//           key:'myspace',
...
//  				,{name:'del.icio.us',key:'del',url:'http://del.icio.us/post?url=%s&title=%t Captured by Screenshot Extension - https://www.openscreenshot.com',dataType:'image'}
//   				,{name:'Digg',key:'digg',url:'http://digg.com/submit?url=%s&title=%t Captured by Screenshot Extension - https://www.openscreenshot.com',dataType:'image'}
]